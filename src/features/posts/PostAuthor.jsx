  ...
  return (
    <div className="flex">
      ...
      <div className="text-black font-semibold text-md flex flex-col justify-center flex-1 truncate">
        <div className="flex items-baseline cursor-pointer w-full" onClick={() => navigate(`/${username}`)}>
          <div>{firstName + ' ' + lastName}</div>
          <div className="text-sm text-gray-500 text-opacity-80 font-normal ml-1 truncate">@{username}</div>
        </div>
